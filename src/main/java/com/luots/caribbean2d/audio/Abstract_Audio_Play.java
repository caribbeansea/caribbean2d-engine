 ...
 * @author tiansheng
 */
public abstract class Abstract_Audio_Play extends Thread implements Audio_Play
{
    ...
    public Abstract_Audio_Play(String name, File file) throws IOException, UnsupportedAudioFileException
    {
