package com.torvbell.game_engine.audio;
 ...
 * @author tiansheng
 */
public abstract class abstract_audioplay extends Thread implements audio_play
{
    ...
    public abstract_audioplay(String name, File file) throws IOException, UnsupportedAudioFileException
    {
